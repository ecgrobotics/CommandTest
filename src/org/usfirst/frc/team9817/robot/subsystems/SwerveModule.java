...
public class SwerveModule {
    ...
    public SwerveModule(SpeedController driveController, SpeedController steerController, 
    	...
    	steerPID = new PIDController(Constants.PID.swerveP, Constants.PID.swerveI, Constants.PID.swerveD,
    			steerEncoder, steerController);
    	steerPID.setInputRange(0, 2*Math.PI);
    	steerPID.setOutputRange(-Constants.PID.swerveCap, Constants.PID.swerveCap);
